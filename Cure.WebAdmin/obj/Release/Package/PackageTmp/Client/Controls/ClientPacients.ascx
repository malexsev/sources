            ...
            <div class="content">
                ...
                <dx:ASPxGridView ID="uxVisitGrid" ClientInstanceName="gvVisits" runat="server" AutoGenerateColumns="False" DataSourceID="uxVisitDataSource" KeyFieldName="Id" OnRowUpdating="uxVisitGrid_RowUpdating">
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="Находитесь ли на кожно-венерологическом диспансерном учете?" FieldName="Dispanser2" Visible="False" VisibleIndex="27">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Имеет ли опасные для здоровья заболевания?" FieldName="DangerousDiseases" Visible="False" VisibleIndex="28">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Сердечно – сосудистые заболевания?" FieldName="Serdce" Visible="False" VisibleIndex="29">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Заболевания дыхательной системы?" FieldName="Dihalka" Visible="False" VisibleIndex="30">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Инфекционные заболевания?" FieldName="Infections" Visible="False" VisibleIndex="31">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Другие опасные для здоровья и окружающих заболевания?" FieldName="OtherDiseases" Visible="False" VisibleIndex="32">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Эпилепсия (Судороги)" FieldName="Epilispiya" Visible="False" VisibleIndex="33">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Тип судорог" FieldName="SudorogiType" Visible="False" VisibleIndex="34">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Количество эпилептических приступов" FieldName="SudorogiCount" Visible="False" VisibleIndex="35">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Противосудорожные препараты" FieldName="SudorogiMedcine" Visible="False" VisibleIndex="36">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Ремиссия" FieldName="Remission" Visible="False" VisibleIndex="37">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Заключение электроэнцефалограммы" FieldName="Encefalogram" Visible="False" VisibleIndex="38">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="Особенности питания ребенка?" FieldName="Diet" Visible="False" VisibleIndex="39">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Как жует и глотает?" FieldName="Eating" Visible="False" VisibleIndex="40">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Пищеварительные проблемы?" FieldName="EatingProblems" Visible="False" VisibleIndex="41">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="Разговаривает?" FieldName="Razgovor" ShowInCustomizationForm="True" UnboundType="String" Visible="False" VisibleIndex="55">
                            <PropertiesTextEdit MaxLength="250">
                            </PropertiesTextEdit>
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Инструкции выполняет?" FieldName="Instructcii" ShowInCustomizationForm="True" UnboundType="String" Visible="False" VisibleIndex="56">
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                    </Columns>
