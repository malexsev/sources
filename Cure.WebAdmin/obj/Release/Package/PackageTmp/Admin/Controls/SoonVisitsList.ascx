...
<dx:ASPxGridView ID="uxMainGrid" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" DataSourceID="uxMainDataSource" KeyFieldName="Id">
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn Caption="Дата рождения" FieldName="PacientId" VisibleIndex="8" Width="60px">
            <PropertiesComboBox DataSourceID="uxPacientDataSource" TextField="BirthDate" ValueField="Id">
            </PropertiesComboBox>
            <DataItemTemplate>
