<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeBehind="RefGmfcsList.aspx.cs" Inherits="Cure.WebAdmin.Admin.RefGmfcsList" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content">
        ...
        <asp:ObjectDataSource ID="uxMainDataSource" runat="server" DataObjectTypeName="Cure.DataAccess.RefGmfcsLevel" DeleteMethod="DeleteRefGmfcsLevel" InsertMethod="InsertRefGmfcsLevel" SelectMethod="GetRefGmfcsLevels" TypeName="Cure.DataAccess.BLL.DataAccessBL" UpdateMethod="UpdateRefGmfcsLevel">
