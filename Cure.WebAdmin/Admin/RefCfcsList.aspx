<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeBehind="RefCfcsList.aspx.cs" Inherits="Cure.WebAdmin.Admin.RefCfcsList" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content">
        ...
        <asp:ObjectDataSource ID="uxMainDataSource" runat="server" DataObjectTypeName="Cure.DataAccess.RefCfcsLevel" DeleteMethod="DeleteRefCfcsLevel" InsertMethod="InsertRefCfcsLevel" SelectMethod="GetRefCfcsLevels" TypeName="Cure.DataAccess.BLL.DataAccessBL" UpdateMethod="UpdateRefCfcsLevel">
