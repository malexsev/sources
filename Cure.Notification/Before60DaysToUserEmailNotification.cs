    ...
    public class Before60DaysToUserEmailNotification : BaseNotification
    {
        ...
        public override bool Send()
        {
            ...
            foreach (var order in this.orders)
            {
                ...
                result = SendEmail(user.LoweredEmail, string.Empty, this.subject, string.Format(this.body, order.DateFrom.ToString("dd-MM-yyyy")), "Опопвещение за 60 дней до заезда");
